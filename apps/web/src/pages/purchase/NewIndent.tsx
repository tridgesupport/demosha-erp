...
import {
  fetchFinancialYears, fetchNextIndentNumber,
  fetchPurchaseDepartments, createPurchaseDepartment,
} from '@/lib/api';
                ...
                {lines.map((line, idx) => (
                  <tr key={idx} className="align-top">
                    ...
                    <td className="px-3 py-2">
                      <ItemSearchCell description={line.description} unit={line.unit} item_id={line.item_id} idx={idx} onChange={updateLine} />
                    </td>
                    <td className="px-3 py-2">
