-- ============================================================
-- tally_analytics_fy2123 — P&L ledger-level drill-down
--
...
DROP VIEW IF EXISTS tally_analytics_fy2123.v_profit_and_loss_by_ledger CASCADE;

CREATE OR REPLACE VIEW tally_analytics_fy2123.v_pnl_ledger_period_activity AS
WITH per_date AS (
