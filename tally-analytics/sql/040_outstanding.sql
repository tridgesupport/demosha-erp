-- ============================================================
-- tally_analytics — Outstanding (Accounts Receivable / Payable)
--
...
JOIN tally_analytics.v_ledger_dim ld ON ld.name = b.ledger
JOIN tally_analytics.v_voucher_dim vd ON vd.guid = b.guid
...
JOIN tally_analytics.v_ledger_dim ld ON ld.name = o.ledger;

COMMENT ON VIEW tally_analytics.v_bill_fact IS
...
COMMENT ON VIEW tally_analytics.v_bill_outstanding IS
...
COMMENT ON VIEW tally_analytics.v_ar_customer_summary IS
...
JOIN tally_analytics.v_ledger_dim ld ON ld.name = l.name
LEFT JOIN (
...
COMMENT ON VIEW tally_analytics.v_ar_reconciliation_check IS
