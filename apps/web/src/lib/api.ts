...
// Dispatch Schedule — every "sent to factory" order, auto-listed. Just a
// tentative date + remark per order, no separate schedule entity.
export const fetchDispatchSchedule = () =>
  request('/api/dispatch-schedules');
