...
FROM tally_analytics.v_item_dim;
...
JOIN tally_analytics.v_voucher_dim vd ON vd.guid = i.guid AND vd.nature <> 'Receipt Note'
...
CREATE MATERIALIZED VIEW tally_analytics.v_inventory_period_balance AS
WITH per_date AS (
...
COMMENT ON MATERIALIZED VIEW tally_analytics.v_inventory_period_balance IS
...
COMMENT ON VIEW tally_analytics.v_inventory_by_group_period IS
